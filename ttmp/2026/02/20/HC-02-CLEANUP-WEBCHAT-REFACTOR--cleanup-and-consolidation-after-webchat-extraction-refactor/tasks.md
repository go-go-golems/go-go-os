...
- [ ] F3: Align `ChatWindow.onSend` async contract with `useConversation.send` to avoid unhandled promise rejections and make send failures observable at component level
