...
export const selectArcLatestCommandForRuntimeSession = (
  state: ArcBridgeStateSlice,
...
export const selectArcGameBySessionId = (state: ArcBridgeStateSlice, sessionId: string) =>
  state.arcBridge.games[sessionId];

export const selectArcSessionById = (state: ArcBridgeStateSlice, sessionId: string) =>
  state.arcBridge.sessions[sessionId];
